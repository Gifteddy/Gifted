    ...
    <section ref={ref} className="relative flex min-h-screen flex-col items-center justify-center px-4 pt-20 overflow-hidden bg-surface-light dark:bg-surface-dark">
      ...
      >
        <div
          ...
          style={{ padding: '30px' }}
        >
          <span className="block font-display text-6xl font-bold text-gradient sm:text-7xl leading-none tracking-tight">
            Offline
          </span>

          <span
            aria-hidden="true"
            className="absolute inset-0 font-display text-6xl font-bold sm:text-7xl leading-none pointer-events-none tracking-tight"
            style={{
              padding: '30px',
