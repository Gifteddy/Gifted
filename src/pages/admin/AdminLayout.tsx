...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/admin/partners', label: 'Partners', icon: Icons.handshake },
      { to: '/admin/commissions', label: 'Commissions', icon: Icons.chart },
      { to: '/admin/payouts', label: 'Payouts', icon: Icons.receipt },
      { to: '/admin/partner-settings', label: 'Partner Settings', icon: Icons.sliders },
