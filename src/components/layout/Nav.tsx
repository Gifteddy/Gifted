      ...
      <header className={`fixed top-0 left-0 right-0 z-[100] h-16 transition-all duration-500 ${
        ...
        <nav className="mx-auto flex h-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link to="/" className="relative z-10 flex items-center">
            <img src="https://res.cloudinary.com/dr4fjf3a1/image/upload/f_auto,q_auto/v1781723693/logo_u7assw.png" alt="Gifted" className="h-12 w-auto" loading="eager" decoding="async" width="48" height="48" />
          </Link>
